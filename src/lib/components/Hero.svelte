<div class="pt-20 pb-24 text-center px-4 lg:px-0">
  <h1
    class="mx-auto max-w-4xl font-lexend text-4xl font-medium tracking-wide text-slate-900 sm:text-7xl"
  >
    Supporting
    <span class="relative whitespace-nowrap text-christi-600">
			<svg
        aria-hidden="true"
        viewBox="0 0 418 42"
        class="absolute top-2/3 left-0 h-[0.58em] w-full fill-christi-300/70"
      ...
      >
        ...
        />
			...
			<span class="relative"> Gospel Ministry </span>
		</span>
    Leaders
  </h1>
  <p class="mx-auto mt-6 max-w-2xl text-lg tracking-wide text-slate-700">
    Many ministry leaders are lonely and discouraged. We exist to bring care and attention to enhance their joy in
    Jesus, life, and serving.
  </p>
  <div
